...
public class ExplosiveTalismanItem extends BaseThrowableTalisman {
    public ExplosiveTalismanItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        if (!world.isClient && user instanceof PlayerEntity player) {
            ...
            ThrownTalismanEntity talismanEntity = new ThrownTalismanEntity(world, player, ThrownTalismanEntity.TYPE_EXPLOSIVE);
