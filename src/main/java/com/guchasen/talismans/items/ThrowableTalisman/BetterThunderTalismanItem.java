...
public class BetterThunderTalismanItem extends BaseThrowableTalisman {
    public BetterThunderTalismanItem(Settings settings) {
        super(settings);
    }

    @Override
    protected int getUseDuration() {
        return 24; // 1.2 seconds = 24 ticks
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        if (!world.isClient && user instanceof PlayerEntity player) {
            ...
            ThrownTalismanEntity talismanEntity = new ThrownTalismanEntity(world, player, ThrownTalismanEntity.TYPE_BETTER);
