    ...
    public static final ItemGroup TALISMANS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder()
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModItems.BETTER_THUNDER_TALISMAN);
                        entries.add(ModItems.WONDERFUL_THUNDER_TALISMAN);
                        entries.add(ModItems.EXPLOSIVE_TALISMAN);
                        entries.add(ModItems.GREATER_EXPLOSIVE_TALISMAN);
